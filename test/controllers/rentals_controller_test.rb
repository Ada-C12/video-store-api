...
describe RentalsController do
  describe "checkout" do 
    ...
    it "can change available_inventory and movies_checked_out_count" do
      inventory = Rental.last.movie.available_inventory
      checked_out = Rental.last.customer.movies_checked_out_count
      ...
      expect(rental.customer.movies_checked_out_count).must_equal (checked_out + 1)
    end
  end
  ...
  describe "checkin" do 
    ...
    it "can assign a checkin_date and change available_inventory and movies_checked_out_count" do
      post checkout_path, params: @rental
